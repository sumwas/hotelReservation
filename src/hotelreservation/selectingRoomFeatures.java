...
public class selectingRoomFeatures extends javax.swing.JFrame {
...
String finalCheckOut;
         ...
         public selectingRoomFeatures(String selection,  int total, int roomAmount, int days, String timeIn, String timeOut) {
        initComponents();
    ...
    // int totalPrice = price; 
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(selectingRoomFeatures.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new selectingRoomFeatures().setVisible(true);
            }
        });
    }
